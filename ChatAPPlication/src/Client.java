...
public class Client implements ActionListener {
    ...
    Client() {
        ...
        text.addActionListener(this); // Pressing Enter sends message
        f.add(text);
    ...
    private String loadNickname() {
        try (BufferedReader br = new BufferedReader(new FileReader("nickname_client.txt"))) {
        ...
        return "Nila"; // Default name
    }

    private void saveNickname(String newName) {
        try (BufferedWriter bw = new BufferedWriter(new FileWriter("nickname_client.txt"))) {
            bw.write(newName);
        } catch (IOException e) {
            e.printStackTrace();
        }
